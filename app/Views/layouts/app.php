...
<link rel="stylesheet" href="<?= asset('css/style.css') ?>?v=<?= defined('ASSET_VERSION') ? ASSET_VERSION : '6' ?>">
  ...
  <aside class="sidebar" id="appSidebar">
    <div class="sidebar-brand">
      <div class="brand-seal">
        <img src="<?= asset('images/logo-com.png') ?>" alt="Logo COM" width="26" height="26">
      </div>
    ...
    <nav class="sidebar-nav">
      ...
      <a href="<?= url('/verify') ?>" target="_blank" rel="noopener">
    ...
    <div class="sidebar-footer">
      ...
      <span class="admin-role">Masuk sebagai <?= e($admin['username'] ?? '-') ?></span>
  ...
  <main class="main-content">
    <div class="topbar">
      <div class="topbar-left">
        <button class="menu-toggle" data-menu-toggle aria-label="Buka menu"><i class="ti ti-menu-2"></i></button>
        <div>
